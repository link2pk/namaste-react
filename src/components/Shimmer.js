            ...
            <div key={index} className="inline-block shadow m-2 min-h-[273px]">
              <article className=" w-56 flex flex-col h-full animate-pulse">
                ...
                <section className="p-2 flex-column">
                  <h3 className="font-semibold mb-2 mt-3 leading-none bg-gray-300 h-8 w-[80%] "></h3>
                  <div className="text-xs flex-column">
                    <p className=" bg-gray-100 h-4 "></p>
                    <p className=" bg-gray-100 h-4 mb-3 w-1/2"></p>
                    <p className=" bg-gray-100 h-6"></p>
                  </div>
                </section>
              </article>
            </div>
