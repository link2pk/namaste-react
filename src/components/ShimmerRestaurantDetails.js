          ...
          {Array(10)
            ...
            .map((e, index) => {
              return (
                <li
                  key={index}
                  className=" border-b py-4 px-4 container max-w-xl mx-auto grid grid-cols-[1fr_130px] gap-3 items-center animate-pulse"
                >
                  <section>
                    <h4 className="h-[24px] bg-gray-200 w-[80%] mb-2"></h4>
